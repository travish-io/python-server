...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def parse_url(self, path):
        # Just like splitting a string in JS.
        # If the path is "/animals/1", the resulting list will have
        # "" at index 0, "animals" at index 1, and "1" at index 2.
        ...
        try:
            # Convert the string "1" to integer
